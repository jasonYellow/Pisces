...
static gboolean refresh_ui (CustomData *data) {
  ...
  if (gst_element_query_position (data->playbin2, &fmt, &data->duration)) {
...
int main(int argc, char *argv[]) {
  ...
  /* Set the URI to play */
  g_object_set (data.playbin2, "uri", "https://example-files.online-convert.com/video/webm/example.webm", NULL);
